...
Read and follow the procedure at `${CLAUDE_PLUGIN_ROOT}/docs/close.md`. The file may be longer than one read returns; the read is complete only when the tool reports no further page.
